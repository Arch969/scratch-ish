...
const getItemIcons = function (item) {
    ...
    if (item.assetId && item.dataFormat) {
        return {
			...
			assetServiceUri: `https://scratch.cyberumschool.ru/internalapi/asset/${item.assetId}.${item.dataFormat}/get/`        };
    }
    ...
    if (md5ext) {
        ...
        return {
            ...
            assetServiceUri: `https://scratch.cyberumschool.ru/internalapi/asset/${md5ext}/get/`
        };
    }
};
